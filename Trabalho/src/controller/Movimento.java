...
public abstract class Movimento {
    ...
    public Campo[][] moverBranco(int coluna, int linha, int linhaAnterior, int colunaAnterior, boolean rei){
        if(rei){//rei
            ...
            if(this.refugio[colunaAnterior][linhaAnterior].verificarX()){//estava em refugio
                ...
                if(this.refugio[coluna][linha].verificaRefugio()){ //estava em refugio e vai para refugio
                ...
                this.tabuleiro[coluna][linha] = new Rei();
                //verificar se vai para refugio
                if(this.refugio[coluna][linha].verificarX()){ //nao estava em refugio e vai para refugio
                    this.tabuleiro[coluna][linha].setImagem(new ImageIcon("img/reibrancoregufio.png"));
                }
            }
        }else{//normal
